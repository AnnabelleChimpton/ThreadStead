                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Add a bio, photo, and even custom CSS to make your page unique.</p>
                    </div>
                  </div>
              ...
              <RetroCard title="👤 Your Personal Space">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <h4 className="font-bold">🎨 Template Styles</h4>
                    <p className="text-sm text-gray-600">Choose from pre-built themes or create your own:</p>
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div className="bg-gray-100 p-2 border">Classic Web1.0</div>
                      <div className="bg-blue-100 p-2 border">Social Modern</div>
                      <div className="bg-green-100 p-2 border">Minimal Clean</div>
                      <div className="bg-purple-100 p-2 border">Dark Theme</div>
                    </div>
                  </div>
                </div>
              </RetroCard>
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-br from-pink-50 to-purple-50 border border-pink-200 p-4 rounded">
                    ...
                    <p className="text-sm mb-3">
                      Threadstead brings back the creative freedom of personal websites. Use CSS to create 
                      anything from minimalist modern designs to flashy retro masterpieces.
                    </p>
              ...
              <RetroCard title="🔐 Your Digital Identity">
                <div className="space-y-4">
                  <div className="bg-green-50 border-l-4 border-green-400 p-4">
                    <h3 className="font-bold text-green-800 mb-2">🗝️ How Authentication Works</h3>
                    <p className="text-sm text-green-700">
                      Threadstead uses DID (Decentralized Identifiers) instead of traditional passwords. 
                      Your identity is secured by cryptographic keys that you control - no company owns your account!
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>• <strong>True Ownership:</strong> Your identity belongs to you</li>
                      <li>• <strong>Enhanced Security:</strong> No passwords to steal or forget</li>
                      <li>• <strong>Privacy First:</strong> Minimal data collection</li>
                      <li>• <strong>Portability:</strong> Your identity works across platforms</li>
                    </ul>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <RetroCard title="🚀 Start Creating">
                  <div className="space-y-4 text-sm">
                    ...
                    <div>
                      <h4 className="font-bold mb-2">🖼️ Upload Photos</h4>
                      <p className="text-gray-600 mb-2">Add images to your profile gallery.</p>
