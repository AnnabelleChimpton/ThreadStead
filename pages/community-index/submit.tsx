    ...
    return (
      <Layout siteConfig={siteConfig}>
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-600 mb-6">Please log in to submit sites and earn Scout Points.</p>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-500">
            Submit a gem, earn <span className="text-yellow-600 font-bold">Scout Points</span>, and grow the neighborhood.
          </p>
        </div>
            ...
            {step === 'success' && (
              <div className="text-center py-8 space-y-6 animate-in fade-in zoom-in duration-500">
                ...
                <p className="text-xl text-gray-600">
                  You've earned <span className="font-bold text-yellow-600">+50 Scout Points</span>.
                </p>
