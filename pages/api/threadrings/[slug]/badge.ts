        ...
        try {
          ...
          if (threadRing.badge) {
            ...
            badge = await db.threadRingBadge.update({
              ...
              data: {
                title: title !== undefined ? title : threadRing.name,
                subtitle: subtitle !== undefined ? subtitle : threadRing.badge.subtitle,
                templateId: templateId !== undefined ? templateId : threadRing.badge.templateId,
                backgroundColor: backgroundColor !== undefined ? backgroundColor : threadRing.badge.backgroundColor,
                textColor: textColor !== undefined ? textColor : threadRing.badge.textColor,
                imageUrl: imageUrl !== undefined ? imageUrl : threadRing.badge.imageUrl,
                isGenerated: !title && !templateId && !backgroundColor && !textColor && !imageUrl,
                isActive: isActive !== undefined ? isActive : threadRing.badge.isActive
              }
            });
          } else {
            // Create new badge
