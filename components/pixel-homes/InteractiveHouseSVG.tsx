...
const TEMPLATE_POSITIONS = {
  cottage_v1: {
    door: { cx: 106, cy: 155, r: 2 },
    mailbox: { x: 25, y: 150, postHeight: 20 },
    flag: { x: 155, y: 100, poleHeight: 25 },
    threadbook: { x: 135, y: 148, width: 8, height: 3 },
    windows: [
      { x: 55, y: 135, width: 15, height: 15 },
      { x: 130, y: 135, width: 15, height: 15 }
    ]
  },
  townhouse_v1: {
    door: { cx: 106, cy: 155, r: 2 },
    mailbox: { x: 15, y: 155, postHeight: 15 },
    flag: { x: 170, y: 95, poleHeight: 20 },
    threadbook: { x: 85, y: 120, width: 10, height: 3 }, // On address sign
    windows: [
      { x: 40, y: 115, width: 25, height: 20 },
      { x: 135, y: 115, width: 25, height: 20 }
    ]
  },
  loft_v1: {
    door: { cx: 110, cy: 155, r: 2 },
    mailbox: { x: 20, y: 155, postHeight: 15 },
    flag: { x: 160, y: 95, poleHeight: 20 },
    threadbook: { x: 70, y: 90, width: 12, height: 3 }, // On detail bar
    windows: [
      { x: 45, y: 100, width: 20, height: 50 },
      { x: 135, y: 100, width: 20, height: 50 }
    ]
  },
  cabin_v1: {
    door: { cx: 105, cy: 150, r: 2 },
    mailbox: { x: 20, y: 160, postHeight: 10 },
    flag: { x: 160, y: 100, poleHeight: 25 },
    threadbook: { x: 80, y: 165, width: 10, height: 3 }, // On porch
    windows: [
      { x: 55, y: 130, width: 12, height: 12 },
      { x: 133, y: 130, width: 12, height: 12 }
    ]
  }
}
